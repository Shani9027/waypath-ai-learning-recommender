...
- Known skills: ${
    learner.knownSkills.length
      ? learner.knownSkills.join(", ")
      : "None"
  }
...
exports.handler = async (event) => {
  ...
  try {
    console.log("=== WAYPATH BEDROCK DEBUG ===");
    ...
    console.log("Stop reason:", bedrockResponse.stopReason);
    ...
    return response(500, {
      error: "Could not generate a learning path right now.",
      debug: {
        name: error.name,
